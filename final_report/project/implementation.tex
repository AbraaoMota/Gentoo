...
Whenever a request causes the \texttt{request\_logger} page to be loaded, 
To toggle the enabling or disabling of the Action Replay algorithm, the popup page sends a message to the \texttt{action\_replay} script each time the corresponding switch is clicked. 
