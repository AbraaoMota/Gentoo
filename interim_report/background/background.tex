...
\begin{itemize}
	\item \textbf{Full Experience} -  no need to skip AJAX, JS, flash etc
	\item \textbf{Educational}
	\item \textbf{Simpler inner representation \& Less crawling}
	\item \textbf{Human judgement} - Increased likelihood of using the correct attack vector.	 Human judgement is needed anyway - scanner won't know for sure. It's a human process to hack, and people will spend hours in crafting specialised attacks. 
\end{itemize}

This however doesn't mean completely foregoing crawling - it means the project will only handle a smaller subset of possible pages to look at.
