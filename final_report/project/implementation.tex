...
The recommendations in the extension work by analysing the contents of the page, and tweaking the page with visible inputs depending on the inputs present. 	
